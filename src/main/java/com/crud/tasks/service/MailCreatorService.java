...
public class MailCreatorService {
    ...
    public String buildTrelloCardEmail(String message) {
        ...
        context.setVariable("company_goal", companyDetailsConfig.getCompanyGoal());
        context.setVariable("company_email", companyDetailsConfig.getCompanyEmail());
        context.setVariable("company_phone", companyDetailsConfig.getCompanyPhone());
        context.setVariable("goodbye_message", "With regards, "+adminConfig.getAdminName());
